...
<div className="px-4 py-4 text-center">
  ...
  <div className="flex flex-col sm:flex-row sm:items-center justify-center gap-4 sm:gap-6">
    ...
    <div className="flex items-center gap-2 text-sm sm:text-base">
      ...
      <p className="font-bold">ravitejaktextiles@gmail.com</p>
    </div>
    <div className="flex items-center gap-2 text-sm sm:text-base">
      <FaMobileAlt className="text-lg sm:text-xl" />
      <p className="font-bold">+91 95919 37429</p>
    </div>
  </div>
</div>
...
<div className="text-center py-2">
  <p className="font-semibold text-lg">Connect with RAVITEJA TEXTILES on Social Media!</p>
</div>
<div className="flex justify-center py-2">
  <div className="flex items-center gap-6 px-4">
    <a
      href="https://www.instagram.com/ravitejatextiles_?igsh=Znp5eWJmbTBuNDRy"
      className="p-2 duration-200 hover:scale-105"
    >
      <FaInstagram className="text-3xl" />
    </a>
    <a
      href="https://www.facebook.com/ravitejatextiles"
      className="p-2 duration-200 hover:scale-105"
    >
      ...
      {/* Footer Section */}
      <div className="border-t-2 border-gray-300/50 py-2 text-center">
        <span className="font-bold text-white">© 2025 ALL RIGHTS RESERVED  RAVITEJA TEXTILES | </span>
        <span className="font-bold text-yellow-400">MADE BY VIPHRUD TECHNOLOGIES</span>
      </div>
    </div>
  );
};
